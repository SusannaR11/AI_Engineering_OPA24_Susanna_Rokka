...
class IrisInput(BaseModel):
    sepal_length: float = Field(gt=4, lt=8.5) #check EDA 
    #df.describe().T-function for median min and max for sepal_length. 
    # Do the same for the other 3 measurements from model_development.
    # can do with widening the field a bit
